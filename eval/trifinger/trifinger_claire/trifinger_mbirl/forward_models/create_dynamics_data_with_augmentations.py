...
data = torch.load(
    os.path.join(
        _ROOT_DIR, "data/datasets/placing-demos-for-dynamics/demos_placing.data"
    )
)
...
torch.save(
    ...
    os.path.join(
        _ROOT_DIR,
        "data/datasets/placing-demos-for-dynamics/placing_coarse_dynamics_data_augmented.data",
    ),
)
