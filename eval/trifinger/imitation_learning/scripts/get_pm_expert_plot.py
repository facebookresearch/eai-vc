...
def main(cfg):
    ...
    model_info = query(
        ["last_model", "config"], {"id": cfg.expert_render_name}, proj_cfg
    )
    ...
    eval_cfg.logger.run_name = "expert"
    ...
    eval_cfg.evaluator.plot_il = False
    eval_cfg.evaluator.plot_expert = True
    eval_cfg.evaluator.with_arrows = True

    eval_cfg.env.env_settings.params.start_state_noise = 0.0
