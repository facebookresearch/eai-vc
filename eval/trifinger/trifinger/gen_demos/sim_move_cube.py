...
from gen_demos.move_cube_policy import MoveCubePolicy
...
def main(args):
    ...
    final_pos_err_thresh = 0.01  # max final obj pos error, in m
    ...
    policy = MoveCubePolicy(
        env.action_space,
        env.platform,
        time_step=SIM_TIME_STEP,
        use_two_stage_grasp=args.random_init_cube_pos,
        finger_type=finger_type,
    )
