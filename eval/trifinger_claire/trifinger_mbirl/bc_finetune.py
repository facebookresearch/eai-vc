    ...
    def __init__(self, demos, device="cpu"):
        ...
        for demo in demos:
            ...
            for i in range(num_obs):
                ...
                image_preproc = transforms(Image.fromarray(image.astype(np.uint8))).reshape(3, 224, 224)
                goal_image_preproc = transforms(Image.fromarray(goal_image.astype(np.uint8))).reshape( 3, 224, 224)
                obs_dict = {
