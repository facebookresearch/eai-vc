...
def main(args):
    ...
    train_trajs, test_trajs = d_utils.load_trajs(traj_load_info, save_path=save_path, scale=args.scale)
...
def parse_args():
    ...
    parser.add_argument("--demo_dir", default=f"/private/home/clairelchen/projects/demos/", help="Directory containing demos")
    parser.add_argument("--difficulty", type=int, nargs="*", default=[1], help="Difficulty levels")
    parser.add_argument("--n_train", type=int, nargs="*", default=[10], help="Number of training trajectories")
    parser.add_argument("--n_test", type=int, nargs="*", default=[1], help="Number of test trajectories")
    parser.add_argument("--scale", type=float, default=100, help="Amount to scale trajectories by")
