...
**[New]**
- Use the argument `--wandb_name` to give a name to your folder created locally and to the run on wandb
- We can pretrain with two datasets: `imagenet` and `omnidata`, by passing the correct argument through `--dataset_type`
