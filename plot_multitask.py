...
def main():
	tasks = ['mw-mt15', 'mw-drawer-close', 'mw-drawer-open', 'mw-hammer', 'mw-box-close', 'mw-reach', 'mw-push', 'mw-pick-place', 'mw-assembly', 'mw-soccer', 'mw-faucet-close', 'mw-faucet-open', 'mw-door-open', 'mw-door-close', 'mw-window-open', 'mw-window-close']
	...
	plt.savefig('plot_mt.png', bbox_inches='tight')
