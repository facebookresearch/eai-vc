...
def save_model(
    args, epoch, model, model_without_ddp, optimizer, loss_scaler, model_name
):
    ...
    if loss_scaler is not None:
        ...
        model.save_checkpoint(
            save_dir=args.output_dir, tag=model_name, client_state=client_state
        )
