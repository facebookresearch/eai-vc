...
DATADIR = "/datasets01/flickr30k-images/"
OUTDIR = "/checkpoint/aelnouby/datasets/flicker30k"
KARPATHY_SPLIT = "/checkpoint/aelnouby/datasets/mscoco/dataset_flickr30k.json"
...
def main():
    ...
    for idx, entry in enumerate(tqdm(test_split)):
        ...
        fpath = os.path.join(DATADIR, entry["filename"])
