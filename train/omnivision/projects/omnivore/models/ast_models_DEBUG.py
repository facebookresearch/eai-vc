...
class ASTModel(nn.Module):
    ...
    def forward(self, sample_dict):
        ...
        x = (
            sample_dict["audioset"].audio.squeeze(1).transpose(-2, -1)
        )  # rgirdhar: DEBUG, running without a wrapper

        # rgirdhar: original code follows
        x = x.unsqueeze(1)
        x = x.transpose(2, 3)
        ...
        # rgirdhar: Need to return a mapping since running without a wrapper
        return {"audioset": x}
