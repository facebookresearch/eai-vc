run_training() {
    ...
    CMD_COMMON_OPTS="--exp-config $EXP_CONFIG_PATH \
        ...
        VIDEO_DIR ${VIDEO_DIR} \
        MODEL.RGB_ENCODER.pretrained_encoder ${WEIGHTS_PATH} \
        MODEL.RGB_ENCODER.backbone ${BACKBONE} \
    ...
    CMD_TRAIN_OPTS="${CMD_COMMON_OPTS} \
        ...
        TASK_CONFIG.DATASET.DATA_PATH ${REPO_PATH}/data/datasets/objectnav/${ENVIRONMENT}/objectnav_hm3d_77k/${SPLIT}/${SPLIT}.json.gz \
        NUM_PROCESSES ${NUM_ENV} \
        WANDB_NAME ${EXP_NAME} \
    ...
    CMD_EVAL_OPTS="${CMD_COMMON_OPTS} \
        ...
        TASK_CONFIG.DATASET.DATA_PATH ${REPO_PATH}/data/datasets/objectnav/${ENVIRONMENT}/v1/${VAL_SPLIT}/${VAL_SPLIT}.json.gz \
